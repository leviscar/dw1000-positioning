 ...
 *      DWT_LOADEUI      0x0008 - On Wake-up load the EUI from OTP memory into Register file: 0x01 – Extended Unique Identifier.
 *      DWT_GOTORX       0x0002 - On Wake-up turn on the Receiver
 *      DWT_TANDV        0x0001 - Run the (temperature and voltage) Analog-to-Digital Convertors
 *
 ...
 * DWT_INT_SLP2INIT			0x00800000					//sleep to init interrupt
 *
 * input parameters:
